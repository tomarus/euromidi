...
MidiPlug(w/2, panelOuterHeight/2, mountHoleDepth);
MidiPlug(w/2, (panelOuterHeight/4)+(panelOuterHeight/2), mountHoleDepth);
MidiPlug(w/2, panelOuterHeight/4, mountHoleDepth);
}

// support
translate([1,(panelOuterHeight)/2,-1]) cube([2, panelInnerHeight-10, 6], center=true);
translate([w-1,(panelOuterHeight)/2,-1]) cube([2, panelInnerHeight-10, 6], center=true);
